...
Функция ОсвободитьВременныеБазыНаСервере()
	...
	|	ВерсииХранилища.ВременнаяБаза КАК ВременнаяБаза
	|ИЗ
	|	Справочник.ВерсииХранилища КАК ВерсииХранилища
	|ГДЕ
	|	ВерсииХранилища.Владелец = &Хранилище
	|	И НЕ ВерсииХранилища.ВременнаяБаза = ЗНАЧЕНИЕ(Справочник.ноВременныеБазы.ПустаяСсылка)";
	Запрос.УстановитьПараметр("Хранилище", Объект.Ссылка);
	...
	Пока Выборка.Следующий() Цикл
		...
		ОбъектВерсии = Выборка.ВерсияХранилища.ПолучитьОбъект();
