...
Процедура УстановитьПользователяХранилищаВременнойБазы(РеквизитыБазы, Параметры)
	...
	Если ЗначениеЗаполнено(РеквизитыБазы.ПользовательХранилища) Тогда
		...
		Параметры.ИмяПользователяХранилища = РеквизитыПользователя.ИмяПользователя;
		Параметры.ПарольПользователяХранилища = РеквизитыПользователя.ПарольПользователя;
	ИначеЕсли ЗначениеЗаполнено(РеквизитыБазы.ИмяПользователяХранилища) Тогда
		Параметры.ИмяПользователяХранилища = РеквизитыБазы.ИмяПользователяХранилища;
		Параметры.ПарольПользователяХранилища = РеквизитыБазы.ПарольПользователяХранилища;
	КонецЕсли;
